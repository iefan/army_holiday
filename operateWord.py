...
def TransYMD2(date):
    ...
    strYMD = ""
    tmpymd = [`int(ymd[0])`, `int(ymd[1])`, `int(ymd[2])`]
    tmpymd2 = [u"年", u"月", u"日"]
...
def TransYMD(date):
    ymd = date.split('-')
    strYMD = `int(ymd[0])` + u"年" + `int(ymd[1])` + u"月" + `int(ymd[2])` + u"日"
    return strYMD
...
def GenStatWord(title, picpath, listData):
    ...
    barDes = `time.localtime()[0]`+u"本年度各月休假人次统计"
...
if __name__ == '__main__':
    GenStatWord(u"固体队　统计图表", ['C:\\Python25\\Holiday\\pie1.png', 'C:\\Python25\\Holiday\\pie2.png', 'C:\\Python25\\Holiday\\bar1.png'], [['1','a','b'], ['2','c','d']])
#    MyGenWordList([u"BZDD000220090804", u"关博", u"综合处", u"2009正常假30天，晚婚假 10 天，路途（湖南）20天，共计60天。", u"2009-08-04", u"2009-09-10", u"综合处"])
